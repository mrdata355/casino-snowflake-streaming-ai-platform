(() => {
  ...
  const labs = [
    ...
    ['V5 Business Project Quest','12 business missions, 10 casino-repo portfolio projects, 10 ML projects, 10 model-scoring drills, and a repo capability map.','/simulators/v5-business-project-quest.html','Business Projects','featured'],
  ...
  const coreCount=document.querySelector('.control-metrics .metric-card:nth-child(2) strong');if(coreCount)coreCount.textContent='30 + V4 + V5';
  const coreSub=document.querySelector('.control-metrics .metric-card:nth-child(2) small');if(coreSub)coreSub.textContent='defects + reasoning + business/ML projects';
  ...
  if(toolbar && !toolbar.querySelector('[data-v5-projects]')){
    const b=document.createElement('button');b.className='btn control-launch';b.dataset.src='/simulators/v5-business-project-quest.html';b.dataset.title='V5 Business Project Quest';b.dataset.v5Projects='1';b.textContent='V5 Business + ML Projects';
